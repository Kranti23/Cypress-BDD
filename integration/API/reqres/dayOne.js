...
Given('User send the POST request to create the user with body {word} and {word}', (name, job) => {
    cy.request({
        method: 'POST',
...
Then('User should be created with response of {word} and {word}', (name, job) => {
